import unittest
from crmTestSuite1.scripts.CRMtestlogin import MyTestCase as aa
from crmTestSuite1.scripts.CRM工作台测试 import MyTestCase
from crmTestSuite1.scripts.CRM添加员工 import MyTestCase as A
